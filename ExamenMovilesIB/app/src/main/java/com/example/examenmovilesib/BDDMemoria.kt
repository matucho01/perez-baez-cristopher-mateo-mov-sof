...
class BDDMemoria {
    companion object{
        ...
        init {
            ...
            listaBicicletas.add(Bicicleta(1, "Dogma F", "ruta", 2023, 8899.99,1))
            listaBicicletas.add(Bicicleta(2, "Trek Emonda", "ruta", 2021, 5799.99,3))
            listaBicicletas.add(Bicicleta(3, "XTC Advanced", "montaña", 2021, 6799.99,2))
            listaBicicletas.add(Bicicleta(4, "Epic", "montaña", 2021, 4999.99,4))
        }
    }
}
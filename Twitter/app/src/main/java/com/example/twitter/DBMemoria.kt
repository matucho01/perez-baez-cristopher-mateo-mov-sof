...
class DBMemoria {
    companion object {
        val arregloTweets = arrayListOf<Tweet>(
            ...
            Tweet("Hola mundo de Twitter que ya no es Twitter", 178, 254, "Emilio", "@emiliomontalvo12", R.drawable.emiliomontalvo, "10h", 13, 354),
            Tweet("Pensando en por qué tuvieron que pasar las cosas de esta forma", 531, 678, "Andrea", "@__andreapineda__", R.drawable.andreapineda_, "1h", 34, 2534),
        )
        ...
        val arregloMensajes = arrayListOf<Message>(
            ...
            Message("Estuvo buena la carrera?", "Lorena Baez", "@silvi.baez", R.drawable.lorenabaez, "6 Jul 23"),
